...
const SpecialOffer = () => {
  return (
    ...
    max-xl:flex-col-reverse ga-10 max-container">
      ...
      <h2 className="font-palanquin text-4xl capitalize font-bold lg:max-w-xl">
         <span className='text-coral-red mt-4'>Special</span> Offer
      </h2>
      <p className="mt-4 lg:max-w-lg info-text ">
        Embark on a shopping journey that redefines your experience with unbeatable 
        deals. From premier selections to incredible savings, we offer unparalleled value that set us apart.
      </p>
      ...
      <div className="mt-5 flex felx-wrap gap-4 ">
